...
const ItemDetail = () => {
  ...
  const addReview = async() => {
    try {
        await axios.post(`${serverUrl}`+"dish/Add-Reviews/"+`${_id}`, {reviewData,rating})
  ...
  return (
    <div className="itemDetailsPage center">
      <div className="edit">
        <NavLink to ={`${clientUrl}`+"/edit/item/"+`${_id}`}><MdModeEdit className="edit-icon"/></NavLink>
      </div>
            ...
            <div className="detail column">
             ...
             <div className="categoryS">
              ...
              <span className="ratings row">
                <span style={{marginRight:"10px", fontWeight:"600"}}>{Dish?.Ratings == 0 ? "" : Dish?.Ratings}</span>
                    ...
                    {[...Array(5)].map((star, i) => {
                      ...
                      return (
                        <>
                          <AiFillStar
                            className="star"
                            color={R<=(hoverStar||rating)?"gold":"gray"}
                ...
                return (
                  <>
                    <div className="review row a-center" key={i}>
                      <div className="img">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCA20mcul2YxsFjJ3d-Ggdpvf9WnPvOlVwuA&usqp=CAU" alt="" />
                      </div>
                      <div className="rr">
